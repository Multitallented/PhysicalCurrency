...
public class Subtract implements PCurrCommand {
    @Override
    public boolean execute(CommandSender commandSender, String[] args) {
        ...
        WithdrawPlayer.execute(receipt, amount);
        commandSender.sendMessage(ChatColor.GREEN + PhysicalCurrency.getPrefix() +
                "You have subtracted " + Format.execute(amount) + " from " + displayName + ". New balance: " +
